...
export class UpdateBusinessPartnerAddressDto {
  @ApiPropertyOptional({ example: "Head office", maxLength: 80 })
  ...
  @ApiPropertyOptional({ example: "10 rue de la Paix", maxLength: 180 })
  @Transform(normalizeText)
  @IsOptional()
  @IsString()
  @MinLength(1)
  ...
  @ApiPropertyOptional({ example: "75002", maxLength: 20 })
  @Transform(normalizeText)
  @IsOptional()
  @IsString()
  @MinLength(1)
