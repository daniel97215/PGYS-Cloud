...
Les contrats publics Features, Offers, Pricing et Subscriptions sont desormais
implementes par leurs services proprietaires, injectables via des tokens
explicites exportes par leurs modules. Les consommateurs peuvent maintenant
migrer progressivement sans importer les repositories proprietaires.
